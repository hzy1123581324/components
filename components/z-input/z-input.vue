<template>
	<view class="tem-input tem-flex" :class="{
		...
		<view class="tem-input-box1">
			...
			<textarea v-if="type == 'textarea'" class="tem-input-input tem-input-textarea" :style="[getStyle]"
				:value="value" :placeholder="placeholder" :placeholderStyle="placeholderStyle" :disabled="disabled"
				:maxlength="inputMaxlength" :fixed="fixed" :focus="focus" :autoHeight="autoHeight" @input="handleInput"
				@blur="handleBlur" @focus="onFocus" @confirm="onConfirm" />
			<input v-else class="tem-input-input" :type="type == 'password' ? 'text' : type" :style="[getStyle]"
				:value="defaultValue" :password="type == 'password' && !showPassword" :placeholder="placeholder"
				:placeholderStyle="placeholderStyle" :disabled="disabled || type === 'select'"
				:maxlength="inputMaxlength" :focus="focus" :confirmType="confirmType" :cursor-spacing="getCursorSpacing"
			...
			<view class="tem-input-right-icon tem-flex" :class="type == 'textarea'? 'tem-felx-textarea':''">
				<view class="tem-input-right-icon-clear tem-input-right-icon-item"
