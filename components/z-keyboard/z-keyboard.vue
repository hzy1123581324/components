<template>
    <u-popup class="" :mask="mask" :maskCloseAble="maskCloseAble" mode="bottom" :popup="false" v-model="value" length="auto"
        ...
        <block v-if="mode == 'number' || mode == 'card'">
            <number-keyboard :random="random" @backspace="backspace" @change="change" :mode="mode" :dotEnabled="dotEnabled"></number-keyboard>
        </block>
        <block v-else>
            <car-keyboard :random="random" @backspace="backspace" @change="change"></car-keyboard>
        </block>
    </u-popup>
</template>
...
<script>
     ...
     * @example <keyboard mode="number" v-model="show"></keyboard> 
     */
