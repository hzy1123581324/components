...
<script>
     ...
     * @example <z-loading class="loading" mode="circle" ></z-loading>
     * <style>
            .loading{
                --loading-size : 加载图标的大小，（默认34rpx）
                --loading-light 动画活动区域的浅颜色，只对 mode = circle 模式有效（默认#e4e4e4）
                --loading-dark  动画活动区域的深颜色，只对 mode = circle 模式有效（默认#c7c7c7）
            }
     </style>
     */
    export default {
