<template>
    <view class="avatar-box">
        <slot name="avatar">
          <view class="avatar-img" @click="imgtap">
...
<script>
     ...
     * <style>
         .avatar{
             ...
             --title-space  主标题与副标题之间的距离
             --subtitle-font-size  副标题字体大小 默认继承父元素inherit
         }
     </style>
     */
    export default {
        ...
        props: {
            ...
            //     validator(val) {
            //       //  直角，圆形，圆角
            //       return ['square','circle','fillet'].indexOf(val)>-1
            //     }
            // },
            title: {
                type: String,
...
<style scoped>
    ...
    .title{
        font-size: var(--avatar-title-font-size,inherit);
        line-height: 1;
        font-weight: bold;
        color: var(--avatar-title-color,inherit);
    }
    .title:empty{
        display: none;
    }
    .subtitle{
        line-height: 1;
        font-weight: 400;
        color: var(--avatar-subtitle-color,inherit);
        margin-top: var(--avatar-title-space);
        font-size: var(--avatar-subtitle-font-size,inherit);
    }
    .subtitle:empty{
        display: none;
    }
