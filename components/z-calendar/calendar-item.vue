<template>
  <view class="calendar-item-weeks-box" :class="{
    ...
    <view class="calendar-item-weeks-box-item">
      <text v-if="selected&&weeks.extraInfo" class="calendar-item-weeks-box-circle"></text>
      <text:class="{
        "calendar-item-weeks-box-text": true,
      ...
      <text v-if="!lunar&&!weeks.extraInfo && weeks.isDay" class="calendar-item-weeks-lunar-text" :class="{
                'calendar-item-isDay-text':weeks.isDay,
                'calendar-item-isDay':calendar.fullDate === weeks.fullDate && weeks.isDay,
                'calendar-item-checked':calendar.fullDate === weeks.fullDate && !weeks.isDay,
                'calendar-item-multiple': weeks.multiple,
                }">今天</text>
      <text v-if="lunar&&!weeks.extraInfo" class="calendar-item-weeks-lunar-text" :class="{
                'calendar-item-isDay-text':weeks.isDay,
                'calendar-item-isDay':calendar.fullDate === weeks.fullDate && weeks.isDay,
                'calendar-item-checked':calendar.fullDate === weeks.fullDate && !weeks.isDay,
                'calendar-item-multiple': weeks.multiple,
      ...
      <text v-if="weeks.extraInfo&&weeks.extraInfo.info" class="calendar-item-weeks-lunar-text" :class="{
...
<style lang="scss" scoped>
  ...
  .calendar-item-weeks-lunar-text {
