<template>
    <view class="badge-box" v-if="num!=-1">{{number}}</view>
</template>
...
<style scoped>
    .badge-box {
        ...
        min-width: var(--badge-size,var(--size));
        min-height: var(--badge-size,var(--size));
        ...
        padding-left: calc(var(--badge-size,var(--size)) / 4);
        padding-right: calc(var(--badge-size,var(--size)) / 4);
    }
</style>
