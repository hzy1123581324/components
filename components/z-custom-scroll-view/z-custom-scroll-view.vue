<template>
  <view class="flex-reverse grow-full">
    ...
    <scroll-view class="scroll-big-box grow—full" scroll-y="true" @scroll="throttleFun" >
    	<view class="scroll-content">
    		...
    		<!-- 通常固定在右下角，用于返回 -->
    		<view :class="['scroll-fixed',(!showFixed)?'scroll-fixed-disable':fixed==0?'':fixedPercentage!=1?'scroll-fixed-disable':'']" @click="onTapScrollFixed">
